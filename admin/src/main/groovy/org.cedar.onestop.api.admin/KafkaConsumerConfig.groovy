...
class KafkaConsumerConfig {
  ...
  Map<String, Object> consumerConfigs() {
    ...
    configProps.put(ConsumerConfig.CLIENT_ID_CONFIG, 'onestop-admin-metadata-consumer')
    configProps.put(ConsumerConfig.GROUP_ID_CONFIG, 'org.cedar.onestop.api.admin')

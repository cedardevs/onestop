...
func SetOneStopFlags() {
	cli.RegisterBefore(SearchCollectionCmd, utils.ParseOneStopRequestFlags)
	cli.RegisterBefore(SearchGranuleCmd, utils.ParseOneStopRequestFlags)
	cli.RegisterBefore(SearchFlattenedGranuleCmd, utils.ParseOneStopRequestFlags)

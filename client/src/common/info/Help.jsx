...
export default class Help extends React.Component {
    ...
    const mainSiteSnippet = <li>
      Use the <span className={styles.icon} aria-hidden="true"><img src={clock}></img></span> time and
      <span className={styles.icon} aria-hidden="true"><img src={globe}></img></span> space filters
      ...
      <span className={styles.blue} aria-hidden="true"> blue </span> to
      <span className={styles.purple} aria-hidden="true"> purple</span>.
    </li>

    const accessibleSiteSnippet = <li>Use the Start Date, End Date,
      and Bounding Box text boxes to limit results to only those that <u>intersect</u> the given constraints.</li>
		...
		return (
          ...
          <p>
            <b>To get started, just type a term into the Search {accessibleVersion ? 'Text ' : ''}box on the home page and
              click the Search Button</b>
            {accessibleVersion ? '' :
              <i className={styles.icon} aria-hidden="true"><img src={search}></img></i>}
          </p>
          ...
          <ul className={styles.tips}>
            ...
            <li>
              ...
              <p>
                <span className={styles.note}>Note:</span> Capitalization is ignored.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                <span className={styles.note}>Note:</span> This means hyphens within terms will be treated as spaces;
                use double quotes to search for a term with a hyphen in it.
              </p>
            </li>

            <li>
              Use of <em>AND</em>, <em>OR</em>, and <em>AND NOT</em> provides similar logic to <em>+</em> and <em>-</em>,
              but introduces operator precedence which makes for a more complicated query structure.
            ...
            <li>
              Not sure if you misspelled something? Not to worry, simply place a tilde after the word
              you're unsure on:
              <ul className={styles.examples}>
                <li>ghrst~</li>
              </ul>
        ...
        <p><b>If you'd prefer to interact directly with the OneStop API, you can find more information about it <A
            target="_blank" href='https://github.com/cedardevs/onestop/wiki/OneStop-Search-API'
            style={{color: '#277cb2'}}>here</A></b></p>

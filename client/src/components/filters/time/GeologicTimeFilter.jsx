...
import {FilterColors, FilterStyles, SiteColors} from '../../../style/defaultStyles'
...
const styleTimeFilter = { // TODO duplicate from DateTimeFilter
  ...FilterStyles.MEDIUM,
  ...{padding: '0.618em'},
}

const styleForm = { // TODO duplicate from DateTimeFilter
  display: 'flex',
  flexDirection: 'column',
}

const styleButtonRow = { // TODO duplicate from DateTimeFilter
  display: 'flex',
  flexDirection: 'row',
  alignItems: 'center',
...
const styleButton = { // TODO duplicate from DateTimeFilter
  width: '30.9%',
  padding: '0.309em',
  margin: '0 0.309em',
  fontSize: '1.05em',
...
//   flexDirection: 'row',
// }
const styleLayout = { // TODO duplicate from DateFieldset
  margin: '2px',
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
...
//
const styleLabel = { // TODO duplicate from DateFieldset
  marginBottom: '0.25em',
}
//
const styleField = {
...
const GeologicTimeFilter = props => {
  ...
  const form = (
    <div key="GeologicDateFilterInput::all">
      ...
      >
        <GeologicFormatFieldset geologicFormat={geoFormat} onFormatChange={onFormatChange} />
        <GeologicFieldset startYear={props.startYear} endYear={props.endYear}
...
// </FilterFieldset>
  ...
  const [preset, setPreset] = useState(null) // TODO tons of stuff to do with this widget
  ...
  const presets = (
      ...
      <div style={styleLayout}>
        ...
        >
          ...
          <option value="5">Paleocene-Eocene Thermal Maximum (PETM) 56000000 55000000</option>
        </select>
      </div>
    ...
    <div style={styleTimeFilter}>
      <fieldset style={{padding: '0.618em'}}>
        <legend id="geologicTimeFilterInstructions">
          Provide a start date, end date, or both.

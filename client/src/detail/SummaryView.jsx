    ...
    return (
      <div>
        ...
        <div className={`${styles.dsmmInfo}`}>
          <img src={infoCircle} className={styles.infoCircle} />
  ...
  buildCoordinatesString() {
    ...
    if (geometry) {
      ...
      if (geometry.type.toLowerCase() === 'point') {
        return `Point at ${geometry.coordinates[0]}${deg}, ${
          geometry.coordinates[1]
        }${deg} (longitude, latitude).`
      } else {
        return `Bounding box covering ${geometry.coordinates[0][0][0]}${deg}, ${
          geometry.coordinates[0][0][1]
        }${deg}, ${geometry.coordinates[0][2][0]}${deg}, ${

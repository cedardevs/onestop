...
class Section508Landing extends React.Component {
      ...
      (collector, fieldDef, name) => {
        ...
        if (valid) {
          ...
          return _.set(
            collector,
            `errors.${name}`,
            `Invalid value for the ${fieldDef.label}`
          )
        }
      },
      {values: {}, errors: {}}
  ...
  render() {
    const formInputs = _.map(this.fields, (fieldDef, name) => (
      <div className={styles.formRow} key={name} data-id="formRow">
    ...
    return (
      <div className={styles.showcase}>
        ...
        <div className={styles.accessibilityStatement}>
          ...
          <p>
            NOAA OneStop is committed to providing access to all individuals who
            are seeking information from our website. We strive to meet or
            exceed requirements of Section 508 of the Rehabilitation Act, as
            amended in 1998.
          </p>
          <p>
            We recognize not all pages on our site are fully accessible at this
            time, however our accessible site aims to meet Level AA
          ...
          <p>
            If you experience any challenges while accessing parts of our site,
            please contact{' '}
        ...
        <div role="alert" className={styles.errors}>
          ...
          <ul>
            {_.map(errors, (message, field) => (
              <li key={field}>
                <a
                  onClick={() => this.inputs[field].focus()}

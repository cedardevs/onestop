...
class Background extends React.Component {
  render() {
    ...
    const styleBackgroundImage = onHomePage ? styleBackgroundEarth : styleBackgroundPattern
    const styleBackgroundOverlay = onHomePage ? styleBackgroundEarthOverlay : styleBackgroundGradient
    return (
        <div style={styleBackgroundImage}>
          <div style={styleBackgroundOverlay}>
            {this.props.children}
          </div>
        </div>
    )

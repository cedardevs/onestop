    ...
    const renderSVG = (
        <div style={styleEarth}>
          <svg
              width="100%"
              height={EARTH_HEIGHT}
              xmlns="http://www.w3.org/2000/svg" style={styleEarthSVG}
          >
            <defs>
              <pattern id="image" patternUnits="userSpaceOnUse" height={EARTH_HEIGHT} width="100%">
            ...
            <rect width="100%" height={EARTH_HEIGHT} fill="url(#image)" mask="url(#arc-mask)"/>
          </svg>

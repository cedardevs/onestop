		...
		return (
			<div>
				<div style={styleResultCountContainer}>
					<h1 style={styleResultCountMerged} tabIndex={0} ref={resultCount => (this.resultCount = resultCount)} onFocus={this.handleFocusResultsCount} onBlur={this.handleBlurResultsCount}>

...
import { toggleGranuleFocus, toggleCollectionSelection, retrievingGranules, receivingGranules, clearGranules } from '../../src/granules/GranulesActions'
...
describe('The granules reducer', function() {
  ...
  it('marks inFlight true while retrieving granules', function () {
    ...
    const result = granules(initial, retrievingGranules())
  ...
  it('marks inFlight false while receiving granules', function () {
    ...
    const result = granules(initial, receivingGranules([{id: 'A'}]))
  ...
  it('merges received granules into the map of granules', function () {
    ...
    const firstRoundResult = granules(initialState, receivingGranules(firstRoundData))
    ...
    const secondRoundResult = granules(firstRoundResult, receivingGranules(secondRoundData))

...
![Grid tile out of focus with 1 line of title visible](/onestop/images/ui-id/default-title-card.png)

Grid collection tile appearance when in focus:

![Grid tile in focus with 3 lines of title visible](/onestop/images/ui-id/expanded-title-card.png)
...
![Result count header with list button circled](/onestop/images/ui-id/list-toggle.png)
...
![Result count header with 3 buttons circled](/onestop/images/ui-id/grid-toggle.png)
...
![Location filter with map visible](/onestop/images/ui-id/location-in-sync.png)
...
![Embedded location help diagram showing "fully contains" relationship](/onestop/images/ui-id/location-filter-help.png)
...
![Invalid coordinates and warning shown on location filter](/onestop/images/ui-id/invalid-coordinates.png)
...
![Embedded date help diagram showing "intersects" relationship](/onestop/images/ui-id/date-filter-help.png)
...
![Warning on Geologic tab when a Datetime filter has already been applied](/onestop/images/ui-id/multi-date-warning.png)
...
![Error indicators and message displayed on invalid start and end dates](/onestop/images/ui-id/datetime-errors.png)
...
![Applying a "Result fully contains the Pliocene" Geologic date filter](/onestop/images/ui-id/geo-date-interval.png)
...
![Data Theme category expanded to show multiple sub-keywords under "Oceans"](/onestop/images/ui-id/expanded-data-theme.png)
...
![Data Theme category expanded with a keyword selected](/onestop/images/ui-id/selected-expanded-data-theme.png)
...
![Showing 83 results with just "Oceans > Ocean Temperature" selected](/onestop/images/ui-id/one-theme-results.png)

No change when "Oceans > Ocean Temperature" and "Atmosphere > Aerosols" applied:

![Showing 83 results with both "Ocean Temperature" and "Aerosols" selected](/onestop/images/ui-id/multi-theme-1.png)

An increase when "Oceans > Ocean Temperature" and "Spectral/Engineering" applied:

![Showing 87 results with both "Ocean Temperature" and "Spectral/Engineering" selected](/onestop/images/ui-id/multi-theme-2.png)
...
![Data Theme keyword counts with just the text query applied](/onestop/images/ui-id/results-without-theme-keywords.png)
...
![Showing a narrowed down result count when attributes from multiple categories are selected](/onestop/images/ui-id/results-multi-category.png)
...
![File results view with tags for every available filter type shown](/onestop/images/ui-id/filter-tags.png)
...
![The top half of a collection detail page](/onestop/images/ui-id/top-collection-detail.png)
...
![The Overview tab of a collection detail page](/onestop/images/ui-id/overview-collection-detail.png)

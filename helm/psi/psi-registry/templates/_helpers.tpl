...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "psi-registry.cp-kafka-headless.fullname" -}}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "psi-registry.cp-schema-registry.fullname" -}}
...
*/}}
{{- define "psi-registry.cp-schema-registry.service-name" -}}

...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "psi-manager.cp-kafka-headless.fullname" -}}
...
*/}}
{{- define "psi-manager.kafka.bootstrap.servers" -}}
{{- if .Values.kafka.bootstrap.servers -}}
{{- .Values.kafka.bootstrap.servers -}}
{{- else -}}
{{- printf "PLAINTEXT://%s:9092" (include "psi-manager.cp-kafka-headless.fullname" .) -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "psi-manager.kafka.schema.registry.url" -}}
{{- if .Values.kafka.schema.registry.url -}}
{{- printf "%s" .Values.kafka.schema.registry.url -}}
{{- else -}}
{{- printf "http://%s:8081" (include "psi-manager.cp-schema-registry.fullname" .) -}}
{{- end -}}
{{- end -}}
